...
def populate_wr_data(yr, wk, p1, p3, p5, points1, points3, points5, pid): 
    global WR_DATA
    local_wr_data = []
    local_wr_data = [p1.name, p1.receiving_yds, p1.receiving_tds, p1.receiving_rec, points1, p3.receiving_yds, p3.receiving_tds, p3.receiving_rec, points3, p5.receiving_yds, p5.receiving_tds, p5.receiving_rec, points5]
...
def populate_qb_data(yr, wk, p1, p3, p5, points1, points3, points5, pid):
    global QB_DATA
    local_qb_data = [p1.name, p1.passing_yds, p1.passing_tds, p1.passing_att, p1.passing_cmp, p1.passing_ints, points1, p3.passing_yds, p3.passing_tds, p3.passing_att, p3.passing_cmp, p3.passing_ints, points3, p5.passing_yds, p5.passing_tds, p5.passing_att, p5.passing_cmp, p5.passing_ints, points5]
    actual_points = getFantasyPoints(0, pid)
